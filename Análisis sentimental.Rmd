...
###*aplico barplot, seleccionado en height la columna o sentimiento que deseo ver y names lo hago manual, observando scores_cloud*
```{r}
barplot(height=sort(scores_cloud$alegria, decreasing = TRUE)[1:2], names=c("mejor","felicidad")[1:2], las=2, ylim=c(0, 400))
```
